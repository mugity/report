create table class ( id int auto_increment not null primary key, starting_class varchar(100), usable_weapons varchar(100), class_change varchar(100), additional_weapon varchar(100) );
