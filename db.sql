create table class ( id int auto_increment not null primary key, start_class varchar(100), usable_weapons varchar(100), class_change varchar(100), add_weapon varchar(100), classification int );
